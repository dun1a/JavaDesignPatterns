...
// an abstract class
// defines basic behaviours of an aircraft
// has an instance of Intention (takeoff or landing) and communicates its runway requests to the control tower upon creation
